...
QT_MOC_LITERAL(1, 9, 9), // "dlgReturn"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 21) // "on_pushButton_clicked"

    },
    "myDialog\0dlgReturn\0\0on_pushButton_clicked"
};
...
void myDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (myDialog::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myDialog::dlgReturn)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myDialog::dlgReturn(int _t1)
{
