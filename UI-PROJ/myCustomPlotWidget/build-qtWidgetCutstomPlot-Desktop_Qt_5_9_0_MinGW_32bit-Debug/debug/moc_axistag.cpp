...
#include "../../qtWidgetCutstomPlot/axistag.h"
...
const QMetaObject AxisTag::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AxisTag.data,
      qt_meta_data_AxisTag,  qt_static_metacall, nullptr, nullptr}
};
...
void *AxisTag::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AxisTag.stringdata0))
        return static_cast<void*>(const_cast< AxisTag*>(this));
