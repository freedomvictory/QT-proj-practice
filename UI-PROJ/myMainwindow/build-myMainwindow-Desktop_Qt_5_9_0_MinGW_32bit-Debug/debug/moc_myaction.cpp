...
#include "../../myMainwindow/myaction.h"
...
void Myaction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Myaction::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Myaction::getText)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Myaction::staticMetaObject = {
    { &QWidgetAction::staticMetaObject, qt_meta_stringdata_Myaction.data,
      qt_meta_data_Myaction,  qt_static_metacall, nullptr, nullptr}
};
